...
<body>
   ...
   <div class="flex justify-center relative">
    ...
    <div class="container menu p-3">
       <ul class="md:flex md:justify-between md:px-[150px] py-5">
        ...
        <li class="text-white"><a href="logout.php">LogOut</a></li>
       </ul>
    </div>
   ...
   <div id="bg-home" class="md:my-[200px] h-full">
    <div class="justify-center mx-2 absolute md:ml-[320px] mt-5 sect">
        <div class="w-[900px] sect1 flex justify-between border-2 border-blue-500">
            <h1 class="p-3">Total Number of User</h1>
            <span class="rounded bg-red-600 w-[100px] m-1 text-center text-gray-100 p-2">49</span>
            <!-- <p><?php echo $total_rows; ?></p> -->
        </div>
        <div class="w-[900px] sect1 flex justify-between border-2 border-blue-500 my-10">
            <h1 class="p-3">Total Number of Product Uploaded</h1>
            <span class="rounded bg-red-600 w-[100px] m-1 text-center text-gray-100 p-2">59</span>
